...
class GenyCloudDriver extends AndroidDriver {
  constructor(config) {
    ...
    this._deviceAllocator = new GenyCloudInstanceAllocation(this._deviceRegistry, this._deviceCleanupRegistry, instanceLookupService, this._instanceLifecycleService, this.emitter);
  ...
  async acquireFreeDevice(deviceQuery) {
    ...
    const instance = await this._deviceAllocator.allocateDevice(recipe);
  ...
  async shutdown(instance) {
    await this._deviceAllocator.deallocateDevice(instance);
  }
